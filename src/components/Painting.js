...
export default function Painting({
  ...
  return (
    <div>
      <img src={imageUrl ?? defaultImage} alt={title} width="480" />{/*если imageUrl не получен отобразится defaultImage, оператор "??" если занчение слева не прводися к true, отобразится значение справа от орепатора*/}
      <h2>{title}</h2>
      <p>
